			...
			if (!o && !r) {
				setTimeout(function () {
					...
					subtitlePullUp.insertAdjacentHTML('beforeend',
						`<div class="subtitle pull-up shorta">¿Problemas de último momento?<strong>¡Olvídate de ellos con nuestro FlexiSMART!</strong></div>`);
					...
					var textFlexismart = `<div class="flexismart-banner">
												...
												<span class="span-style">Modifica tu reserva cuantas veces quieras por un año</span><br>
												<i class="js-icon js-flexi-tick"></i>
												<span class="span-style">Podrás cambiar tu reserva hasta una hora antes del vuelo</span><br>
												<i class="js-icon js-flexi-tick"></i>
												<span class="span-style">¡No pagarás cargo por ningún cambio!</span>
											</div>
											<div class="text-tarifaria">
												*Aplica diferencia tarifaria si corresponde.
											</div>
											`
					...
					var textFlexibilidad = document.querySelectorAll(".ts-flexi-fee .extras-binary-name").forEach(function (textFlexibilidad) {
						textFlexibilidad.innerHTML = `¡Quiero flexibilidad solo por ${currencyDicc[flexiCurrency]}${datoFormateado}!`
					})
