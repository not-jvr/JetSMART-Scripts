var initMsgMantencionSeat = setInterval(function () {
  if (typeof bookingData === "undefined" || window.location.pathname !== '/Seat/Map') return;
  clearInterval(initMsgMantencionSeat);

  var culture = bookingData.Culture;
  function addMsgMantencion(selector) {
    if(!document.querySelector('#mantencion-msg-seat-map')){
      ...
      newElement.id = 'mantencion-msg-seat-map';
  ...
  addMsgMantencion('.col-xs-1.ts-error-parent.ts-error-container')
}, 400);