var bundlesMoreSimpleV2 = setInterval(function() {
  if (typeof bookingData === "undefined" || window.location.pathname !== '/V2/Flight') return;
  clearInterval(bundlesMoreSimpleV2);
  ...
  function hideExtras(){
    if (bancoEstado < 1) {
      var elements = document.querySelectorAll('ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|FLXB"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|LBGC|LBGD|LBGC|LBAG|BAGC|BAGD"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|PBOA|PBA|PBD|PBP"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|SOMESEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|ALLSEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|APCH|APCA|APCD|APCP"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|simple|ALLSEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|simple|APCH|APCA|APCD|APCP"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|FLXB"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|LBGC|LBGD|LBGC|LBAG|BAGC|BAGD"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|PBOA|PBA|PBD|PBP"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|SOMESEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|ALLSEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|APCH|APCA|APCD|APCP"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|simple|ALLSEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|simple|APCH|APCA|APCD|APCP"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|LBGC|LBGD|LBGC|LBAG|LBG1|LBG2|BAGC|BAGD|BAG1|BAG2"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|LBGC|LBGD|LBGC|LBAG|LBG1|LBG2|BAGC|BAGD|BAG1|BAG2"]');
      elements.forEach(function (element) {
        if(element){
          element.style.visibility = 'hidden';
        }
      });
    } else if (bancoEstado > 0) {
      console.log("chao")
      var elementos = document.querySelectorAll('ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|FLXB"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|LBGC|LBGD|LBGC|LBAG|LBG1|LBG2|BAGC|BAGD|BAG1|BAG2"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|SOMESEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|ALLSEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|none|APCH|APCA|APCD|APCP"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|simple|SOMESEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|0-c|simple|ALLSEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|FLXB"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|LBGC|LBGD|LBGC|LBAG|LBG1|LBG2|BAGC|BAGD|BAG1|BAG2"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|SOMESEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|ALLSEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|none|APCH|APCA|APCD|APCP"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|simple|SOMESEATS"], ac-bundles-selector [data-test-id="bundle-ssr-item--j|1-c|simple|ALLSEATS"]');
