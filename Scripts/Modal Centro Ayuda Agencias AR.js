var initChangeModalAgenciasAR = setInterval(function () {
	if (!window.location.pathname.includes('/centro-ayuda-agencias')) return;
	clearInterval(initChangeModalAgenciasAR);

	var culture;

	if (window.location.pathname.startsWith('/ar/es/minisitios/centro-ayuda-agencias')) {
		culture = 'es-AR'
	}
