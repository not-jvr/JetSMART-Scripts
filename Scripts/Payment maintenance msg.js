var initMsgMantencionPayment = setInterval(function () {
  if (typeof bookingData === "undefined" || window.location.pathname !== '/V2/Payment') return;
  clearInterval(initMsgMantencionPayment);

  var culture = bookingData.Culture;
  function addMsgMantencion(selector) {
    if(!document.querySelector('#mantencion-msg-payment')){
      ...
      newElement.id = 'mantencion-msg-payment';
