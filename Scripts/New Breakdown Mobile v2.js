var initNewBreakDownV2 = setInterval(function () {
    ...
    clearInterval(initNewBreakDownV2);
    ...
    function addCSS() {
        ...
        @media (max-width: 767px) {
            ...
            .rounded-primary-btn:after {
                display: none;
            }

            [data-test-id="passengers-submit-button"]:after {
                display: none;
            }

            [data-test-id="baggage-submit-button"]:after {
                display: none;
            }

            [data-test-id="extras-submit-button"]:after {
                display: none;
            }

            .mobile-seatmap-direction-btn:after {
                display: none;
            }
        }
        `;
    ...
    function verificarURL() {
        ...
        if (urlActual.startsWith("https://booking.betauat.dgital.com/V2/Flight")) {
            var existingButton = document.querySelector('#newContinueButtonMobile');
        ...
        } else if (window.location.pathname.includes('/V2/Flight')) {
            var existingButton = document.querySelector('#newContinueButtonMobile');
