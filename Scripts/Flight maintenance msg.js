var initMsgMantencionFlight = setInterval(function () {
  if (typeof bookingData === "undefined" || window.location.pathname !== '/V2/Flight') return;
  clearInterval(initMsgMantencionFlight);

  var culture = bookingData.Culture;
  function addMsgMantencion(selector) {
    if(!document.querySelector('#mantencion-msg-flight')){
      ...
      newElement.id = 'mantencion-msg-flight';
  ...
  addMsgMantencion('.flight-itinerary')
}, 400);