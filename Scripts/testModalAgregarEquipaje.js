...
function createModalBaggage(){
  if(!document.querySelector('#modalBaggageAB')){
    ...
    var text_body = 'Los precios pueden aumentar o el vuelo elegido puede agotarse. ¡Termina tu reserva ahora y evita pagar más!';
    ...
    <div class="top-text-red">Ahorra hasta un 68%</div>
    ...
    var noQuieroButton = document.querySelector(".bottom-text-close a");

    closeModalButton.addEventListener('click', closeModal);
    noQuieroButton.addEventListener('click', closeModal);
