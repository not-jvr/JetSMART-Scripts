var ModalPC_ExitIntentAR = setInterval(function () {
	...
	function isAR() {
		const stationCodes = ["BUE", "CPC", "SLA", "IGR", "TUC", "COR", "MDZ", "NQN", "BRC", "CRD", "FTE", "USH", "EZE"];
	...
	if (culture === 'es-AR' && PC === null && staff !== 'WWW Staff Travel' && isDesktop() && PB === false && isAR() && isAnyDateInRange()) {
		addCSS();
