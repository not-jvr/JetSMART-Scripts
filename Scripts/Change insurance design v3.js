var IMP_12v3 = setInterval(function () {
	if (typeof bookingData === "undefined" || window.location.pathname !== '/V2/Extras' || !document.querySelector(".insurance-content-container .insurance-title")) return;
	clearInterval(IMP_12v3);
	...
	function editInsurance() {
		setTimeout(function () {
			if (document.querySelector(".insurance-description")) {
				...
				<span class="text-dropdown-insurance">Cobertura por cancelación o interrupción de viaje</span>
				<i class="js-icon js-chevron-right promo-open-icon icon-flexi"></i>
				</label>               
				<div class="border-bottom-dropdown">
				<input type="checkbox" id="touch"> 
				<ul class="slide">
				<li><div class="text-dropdown">Recibe hasta $400 USD de reembolso por ticket aéreo, hospedaje y otros gastos no reembolsables en caso de que te veas afectado o algún familiar tuyo por un accidente o enfermedad que te impida viajar</div></li> 
				</ul>
				</div>
				</div><br>
				<div>
	...
	if (culture === 'es-CL' && staff !== 'WWW Staff Travel') {
		addCSS();
		editInsurance();
		clickContinue();
