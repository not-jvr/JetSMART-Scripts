var ModalPC_ExitIntentCO = setInterval(function () {
	...
	function isCO() {
		const stationCodes = ["ADZ", "BOG", "CLO", "CTG", "CUC", "MDE", "PEI", "SMR", "MTR", "BAQ"];
	...
	if (culture === 'es-CO' && PC === null && staff !== 'WWW Staff Travel' && isDesktop() && PB === false && isCO() && isAnyDateInRange()) {
		addCSS();
